...
const FilterSidebar = ({ handleFilter }) => {
  ...
  return (
    <div className="">
      <h2 className="text-xl font-semibold mb-4 capitalize text-stone-500">
        Filters desserts here ...
      </h2>
      {/*category*/}
      <div className="mb-4">
        <div className="font-semibold mb-3 pb-1 border-b-2 border-stone-200">
          Category
        </div>
        <Controller
          name="category"
